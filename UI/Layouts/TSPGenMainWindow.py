...
class Ui_TSPGenMainWindow(object):
	def setupUi(self, TSPGenMainWindow):
		...
		self.menuGeneration.addAction(self.actionProcessGeneration)
	...
	def retranslateUi(self, TSPGenMainWindow):
		...
		self.menuGeneration.setTitle(_translate("TSPGenMainWindow", "Generation"))
		...
		self.actionProcessGeneration.setText(_translate("TSPGenMainWindow", "Process"))
